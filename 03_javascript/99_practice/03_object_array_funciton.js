...
console.log(`최소값 : ${min(c, d)}`);
console.log(`최대값 : ${max(c, d)}`);
...
*/
// 1.
let arrowMin = (a, b) => {return Math.min(a, b)};
let arrowMax = (a, b) => {return Math.max(a, b)};
// 2.
let triMin = (a, b) => (a < b) ? a : b;
let triMax = (a, b) => (a > b) ? a : b;
// 3.
let e = 32
let f = 41
console.log(arrowMin(e, f));
console.log(arrowMax(e, f));
console.log(triMin(e, f));
console.log(triMax(e, f));
...
console.log(`합 : ${myCalc.sum()}`);  // 합 : 30
console.log(`곱 : ${myCalc.multi()}`); // 곱 : 200

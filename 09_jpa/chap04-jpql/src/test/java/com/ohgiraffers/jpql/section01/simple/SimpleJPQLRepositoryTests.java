...
public class SimpleJPQLRepositoryTests {
    ...
    @DisplayName("IN 연산자 사용 조회")
    @Test
    void testSelectUsingIn() {
        List<Menu> inList = simpleJPQLRepository.selectUsingIn();
        System.out.println("menuList : " + inList);
        assertNotNull(inList);
    }

    @DisplayName("LIKE 연산자 사용 조회")
    @Test
    void testSelectUsingLike() {
        List<Menu> likeList = simpleJPQLRepository.selectUsingLike();
        System.out.println("menuList : " + likeList);

...
public class Children {
    ...
    위 네가지 접근제한자는 클래스, 생성자, 클래스의 멤버(필드, 메소드렝 모두 사용 가능하다.
    ...
    클래스 작성시 특별한 목적이 아닌 이상 '캡슐화가 기본 원칙'으로 사용되고 있다.
     */
    private String nickname;    // private로 작성하여 캡슐화
    private int age;
    ...
    보통 외부 접근이 가능하도록 Getter와 Setter는 public으로 한다.
    */
    ...
    public void setAge(int age) {
        if (age >= 0) {
            ...
            // child1.setAge(10); 로 접근했을 때 this는 child1을 가리킴.
        } else {
